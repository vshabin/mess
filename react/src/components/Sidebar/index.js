  ...
  return (
    <div className="chat__sidebar">
      <div className="chat__sidebar-header">
        <div>
          <Icon type="team" />
          <span>Список диалогов пользователя {user && user.fullname}</span>
        </div>
      ...
      <Button type="danger" className="logout-button" onClick={() => {localStorage.removeItem("token");window.location. reload()}}>
            Выйти
      </Button>
      <Modal
